...
- Насколько количественно совпадают модельная и натурная ионограммы — есть ли оценка расхождения по частоте и задержке?
- Каково покрытие карт полос когерентности и как обрабатываются области без данных GNSS?
- Как чувствительность результата к выбору постоянной составляющей ПЭС из IRI влияет на итоговые значения полосы?
